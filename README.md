...
*Note: This command will open your terminal's text editor (like Vim) asking you to save the new commit message. On Mac/Linux, you type `:wq` and press Enter to save and exit.*
